...
function makeItem(itemName,priority,date){
    ...
    div.innerHTML=`
        ...
        <div id="taskIcon">
            <img src="images/check-circle 2.png" id="check" alt="mark complete">
            <img src="images/trash 1.png" id="trash" alt="delete">
        </div>
    `;
    const today = new Date();
    const todayDateString = today.toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' });
...
function addTaskToList(taskDiv,date,itemName,priority,completed){
    ...
    if (completed) {
        ...
        trashBtn.setAttribute('src', 'images/trash 1.png');
    } else {
